      ...
      <div className={styles.tabContent}>
        ...
        {activeTab === "erhverv" && (
          <>
            <section className={styles.infoBlock}>
              <h3>Erhverv</h3>
              <p>Skal din virksomhed afholde en firmafest, julefrokost, sommerfest eller et 
...
og højt humør. 
Musikken skræddersys til jeres ønsker – fra afslappet loungestemning under middagen til fuld fest senere på aftenen.</p>
            </section>

            <Anmeld
              imageSrc="/reviews-erhverv.jpg"
        ...
        {activeTab === "klub" && (
          <>
            <section className={styles.infoBlock}>
              <h3>Klub booking</h3>
              <p>Skal du bruge en DJ til klub, diskotek eller festival? Jeg leverer høj energi, stærk musikalsk timing og et solidt mix, der holder publikum i gang hele natten. Med erfaring fra både intime klubmiljøer og udendørsscener tilpasser jeg mit set og vibe til stemningen og publikum – uanset størrelse og format. 
Musikken spænder bredt, men altid med fokus på flow, energi og en fest, man husker. Jeg stiller med professionelt gear, hvis det ønskes, og er vant til at samarbejde med lydfolk, teknikere og scenecrew for at sikre en gnidningsfri afvikling.</p>
            </section>

            <Anmeld
              imageSrc="/reviews-klub.jpg"
